...
//并使用默认的文档解析器TextDocumentParser对文档进行解析
        Document document = FileSystemDocumentLoader.loadDocument("E:\\baiduNetDisk\\downloads\\硅谷小智（医疗版）\\knowledge\\knowledge\\测试.txt");
...
//                        TextDocumentParser());
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument(
                "E:\\baiduNetDisk\\downloads\\硅谷小智（医疗版）\\knowledge\\knowledge\\医院信息.pdf",
...
//并使用默认的文档解析器对文档进行解析(TextDocumentParser)
        Document document = FileSystemDocumentLoader.loadDocument("E:\\baiduNetDisk\\downloads\\硅谷小智（医疗版）\\knowledge\\knowledge\\人工智能.md");
